...
// @ts-ignore
import type { ModelsCreatorStatusUpdateResponse } from './models-creator-status-update-response';
// May contain unused imports in some cases
// @ts-ignore
import type { ModelsErrorInfo } from './models-error-info';

export interface ModelsStandardCreatorStatusUpdateResponse {
    'data'?: ModelsCreatorStatusUpdateResponse;
