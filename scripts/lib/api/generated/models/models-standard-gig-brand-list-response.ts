...
// May contain unused imports in some cases
// @ts-ignore
import type { ModelsGigBrandListResponse } from './models-gig-brand-list-response';

export interface ModelsStandardGigBrandListResponse {
    'data'?: ModelsGigBrandListResponse;
