...
// May contain unused imports in some cases
// @ts-ignore
import type { ModelsInvoicePDFGeneratedResponse } from './models-invoice-pdfgenerated-response';

export interface ModelsStandardInvoicePDFGeneratedResponse {
    'data'?: ModelsInvoicePDFGeneratedResponse;
