...
// May contain unused imports in some cases
// @ts-ignore
import type { ModelsNotificationListResponse } from './models-notification-list-response';

export interface ModelsStandardNotificationListResponse {
    'data'?: ModelsNotificationListResponse;
