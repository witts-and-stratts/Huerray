...
// May contain unused imports in some cases
// @ts-ignore
import type { ModelsFilePreviewResponse } from './models-file-preview-response';

export interface ModelsStandardFilePreviewResponse {
    'data'?: ModelsFilePreviewResponse;
