...
------------ | ------------- | ------------- | -------------
**data** | [**ModelsUserResponse**](ModelsUserResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { ModelsPaginatedUserResponse } from 'huerray-api';

const instance: ModelsPaginatedUserResponse = {
    data,
    error,
    message,
    pagination,
