...
------------ | ------------- | ------------- | -------------
**data** | [**Array&lt;ModelsGigResponse&gt;**](ModelsGigResponse.md) |  | [optional] [default to undefined]
...
```typescript
import { ModelsPaginatedGigResponse } from 'huerray-api';

const instance: ModelsPaginatedGigResponse = {
    data,
    error,
    message,
    pagination,
