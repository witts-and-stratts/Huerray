...
**brand_status** | **string** |  | [optional] [default to undefined]
...
**company_size** | [**UtilsCompanySize**](UtilsCompanySize.md) |  | [optional] [default to undefined]
...
```typescript
import { ModelsBrandResponse } from 'huerray-api';

const instance: ModelsBrandResponse = {
    brand_id,
    brand_status,
    building_number,
    category,
