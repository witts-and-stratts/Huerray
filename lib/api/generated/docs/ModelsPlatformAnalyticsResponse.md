# ModelsPlatformAnalyticsResponse
...
**total_video_submissions** | **number** |  | [optional] [default to undefined]

## Example

```typescript
import { ModelsPlatformAnalyticsResponse } from 'huerray-api';

const instance: ModelsPlatformAnalyticsResponse = {
    active_brands,
    active_creators,
