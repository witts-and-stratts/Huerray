...
// May contain unused imports in some cases
// @ts-ignore
import type { ModelsGigApplicationResponse } from './models-gig-application-response';

export interface ModelsStandardGigApplicationResponses {
    'data'?: Array<ModelsGigApplicationResponse>;
