...
// May contain unused imports in some cases
// @ts-ignore
import type { ModelsGigCreatorListResponse } from './models-gig-creator-list-response';

export interface ModelsStandardGigCreatorListResponse {
    'data'?: ModelsGigCreatorListResponse;
