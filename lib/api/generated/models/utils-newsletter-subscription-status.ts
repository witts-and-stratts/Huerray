...
export const UtilsNewsletterSubscriptionStatus = {
    NewsletterSubscriptionStatusActive: 'active',
    NewsletterSubscriptionStatusUnsubscribed: 'unsubscribed'
} as const;

export type UtilsNewsletterSubscriptionStatus = typeof UtilsNewsletterSubscriptionStatus[keyof typeof UtilsNewsletterSubscriptionStatus];
