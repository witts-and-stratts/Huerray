...
const imagesByCategory: Record<string, string[]> = {
  'Product Shots': [
    '/images/content/product-1.webp',
    '/images/content/product-2.webp',
    '/images/content/product-3.webp',
    '/images/content/product-4.webp',
    '/images/content/product-5.webp',
    '/images/content/product-6.webp',
    '/images/content/product-7.webp',
    '/images/content/product-8.webp',
    '/images/content/product-9.webp',
    '/images/content/product-10.webp',
    '/images/content/product-11.webp',
    '/images/content/product-12.webp',
    '/images/content/product-13.webp',
    '/images/content/product-14.webp',
    '/images/content/product-15.webp',
  ],
  'Testimonial Videos': [
    '/images/content/testimonial-1.webp',
    '/images/content/testimonial-2.webp',
    '/images/content/testimonial-3.webp',
    '/images/content/testimonial-4.webp',
    '/images/content/testimonial-5.webp',
    '/images/content/testimonial-6.webp',
    '/images/content/testimonial-7.webp',
    '/images/content/testimonial-8.webp',
    '/images/content/testimonial-9.webp',
    '/images/content/testimonial-10.webp',
    '/images/content/testimonial-11.webp',
    '/images/content/testimonial-12.webp',
    '/images/content/testimonial-13.webp',
    '/images/content/testimonial-14.webp',
    '/images/content/testimonial-15.webp',
  ],
  'Unboxing Videos': [
    '/images/content/unboxing-1.webp',
    '/images/content/unboxing-2.webp',
    '/images/content/unboxing-3.webp',
    '/images/content/unboxing-4.webp',
    '/images/content/unboxing-5.webp',
    '/images/content/unboxing-6.webp',
    '/images/content/unboxing-7.webp',
    '/images/content/unboxing-8.webp',
    '/images/content/unboxing-9.webp',
    '/images/content/unboxing-10.webp',
    '/images/content/unboxing-11.webp',
    '/images/content/unboxing-12.webp',
    '/images/content/unboxing-13.webp',
    '/images/content/unboxing-14.webp',
    '/images/content/unboxing-15.webp',
  ],
  'Lifestyle Shots': [
    '/images/content/lifestyle-1.webp',
    '/images/content/lifestyle-2.webp',
    '/images/content/lifestyle-3.webp',
    '/images/content/lifestyle-4.webp',
    '/images/content/lifestyle-5.webp',
    '/images/content/lifestyle-6.webp',
    '/images/content/lifestyle-7.webp',
    '/images/content/lifestyle-8.webp',
    '/images/content/lifestyle-9.webp',
    '/images/content/lifestyle-10.webp',
    '/images/content/lifestyle-11.webp',
    '/images/content/lifestyle-12.webp',
    '/images/content/lifestyle-13.webp',
    '/images/content/lifestyle-14.webp',
    '/images/content/lifestyle-15.webp',
  ],
  'Food & Beverage': [
    '/images/content/content-9.webp',
    '/images/content/content-6.webp',
    '/images/content/content-13.webp',
    '/images/content/content-3.webp',
    '/images/content/content-1.webp',
    '/images/content/content-8.webp',
    '/images/content/content-4.webp',
    '/images/content/content-12.webp',
    '/images/content/content-7.webp',
    '/images/content/content-15.webp',
    '/images/content/content-2.webp',
    '/images/content/content-11.webp',
    '/images/content/content-5.webp',
    '/images/content/content-14.webp',
    '/images/content/content-10.webp',
  ],
  'Travel & Hospitality': [
    '/images/content/travel-1.webp',
    '/images/content/travel-2.webp',
    '/images/content/travel-3.webp',
    '/images/content/travel-4.webp',
    '/images/content/travel-5.webp',
    '/images/content/travel-6.webp',
    '/images/content/travel-7.webp',
    '/images/content/travel-8.webp',
    '/images/content/travel-9.webp',
    '/images/content/travel-10.webp',
    '/images/content/travel-11.webp',
    '/images/content/travel-12.webp',
    '/images/content/travel-13.webp',
    '/images/content/travel-14.webp',
    '/images/content/travel-15.webp',
  ],
};
