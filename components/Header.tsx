  ...
  return (
    <header className='header'>
      ...
      <div className='header__actions'>
        ...
        >
          <span
            className={ `header__hamburger-line ${ isMenuOpen ? 'header__hamburger-line--top-open' : ''
              }` }
          />
          <span
            className={ `header__hamburger-line ${ isMenuOpen ? 'header__hamburger-line--middle-open' : ''
              }` }
          />
          <span
            className={ `header__hamburger-line ${ isMenuOpen ? 'header__hamburger-line--bottom-open' : ''
              }` }
          />
        </button>
      </div>
