...
function FieldDescription( { className, ...props }: React.ComponentProps<"p"> ) {
  return (
    <p
      ...
      className={ cn(
        "text-muted-foreground/70 font-light text-left text-sm [[data-variant=legend]+&]:-mt-1.5 leading-normal group-has-data-[orientation=horizontal]/field:text-balance",
