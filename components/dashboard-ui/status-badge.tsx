...
export function GigStatusBadge( { status, className }: StatusBadgeProps ) {
  return <StatusBadge status={ status } className={ className } />;
}

export function BrandStatusBadge( { status, className }: StatusBadgeProps ) {
  return <StatusBadge status={ status } className={ className } />;
}

export function CreatorStatusBadge( { status, className }: StatusBadgeProps ) {
  return <StatusBadge status={ status } className={ className } />;
}
...
export function InvitationStatusBadge( { status, className }: StatusBadgeProps ) {
  return <StatusBadge status={ status } className={ className } />;
}
