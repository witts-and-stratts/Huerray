...
export async function generateMetadata( { params }: Props ) {
  ...
  return generateSEO( locale, 'creator-terms', { pathname: '/creator-terms' } );
}

export default async function CreatorTerms( { params }: Props ) {
  const { locale } = await params;
    ...
    <>
      ...
      <main className='relative z-30 bg-white mb-40 overflow-y-hidden -mt-40'>
        <div className="padded-container pb-6 md:pb-10 border-b border-b-gray-200 text-center bg-orange-50/50 -mt-40 pt-100">
          ...
          <Typography className="mt-8" dangerouslySetInnerHTML={ { __html: t.raw( 'preInfo' ) } } />
